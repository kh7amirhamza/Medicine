...
public class AllCategoryOfDoctor {

    int id;
    String cat_name,cat_in_bangla,cat_image,created_at,updated_at;

    public AllCategoryOfDoctor(int id, String cat_name, String cat_in_bangla, String cat_image, String created_at, String updated_at) {
        this.id = id;
